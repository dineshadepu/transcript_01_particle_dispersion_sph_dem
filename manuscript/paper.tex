...
a stirrer are commonplace \cite{li2022study}.  \Cref{fig:gloabl_body_frame_rb}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/plane_poiseuille_flow_2D/case_1/comparison.png}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/benchmark_1_ss_colliding_elastic/fn_vs_overlap}
...
given in \Cref{fig:schematic-Dinesh-mixer-homogeneous}. The solid particles
...
\Cref{sec:mixing-spherical-particles-in-fluid-tank-homogeneous}, we analyze circular
