...
class Problem(Application):
    ...
    def consume_user_options(self):
        ...
        # x - axis
        self.rigid_body_width = 48. * 1e-3
        # y - axis
        self.rigid_body_length = 49. * 1e-3
        # z - axis
        self.rigid_body_depth = 24. * 1e-3
    ...
    def create_particles(self):
        ...
        # This is # 4
        rigid_body_master.rad_s[:] = self.rigid_body_width / 2.
        rigid_body_master.h[:] = self.rigid_body_width * 2.
